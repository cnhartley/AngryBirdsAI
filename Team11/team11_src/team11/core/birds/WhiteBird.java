...
/**
 * Provides an object representing a white bird found in the Angry Birds game.
 * 
...
public class WhiteBird extends Bird {
	 ...
	 */
	private static final long serialVersionUID = 5216876067391720274L;

	
	/**
	 * Constructor for a new instance of a white bird found in game with the
	 * specified bounding {@link Rectangle}.
	 * 
	 * @param rect  the {@link Rectangle} boundary for this instance of the
	 *              white bird.
	 */
	public WhiteBird(Rectangle rect) {
		super(WHITE, rect);
	}
